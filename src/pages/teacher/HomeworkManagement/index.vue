<template>
  <view class="homework-management">
        ...
        >
          ...
          <view class="td correction-status">
            ...
            <template v-else>
              <div
                  class="score-info"
                  @click="showGradingModal(item)"
                  @mouseenter="showScoreTooltip($event, item)"
      ...
      <view class="grading-modal">
        ...
        <view class="modal-content">
          ...
          <view class="grading-form">
            <view
                v-for="student in currentGradingHomework?.member"
                :key="student.id"
            ...
            >
              ...
              <input
                  type="number"
                  class="score-input"
                  v-model="gradingForm[student.id]"
                  placeholder="请输入分数"
    ...
    <!-- 成绩悬浮提示 -->
    <view
        v-if="isScoreTooltipVisible"
        class="score-tooltip"
        :style="tooltipStyle"
    >
      <view
          v-for="score in currentScores"
          :key="score.studentId"
          class="tooltip-item"
      >
            ...
            <view class="duplicate-list">
              ...
              >
                <view class="similarity-header">
                  ...
                  <text class="similarity-value">相似度: {{ item.similarity }}%</text>
                </view>
                <view class="similarity-details">
                  <view class="detail-item">
                    <text class="label">简介相似度：</text>
                    <text class="value">{{ item.briefValue }}%</text>
                  </view>
                  <view class="detail-item">
                    <text class="label">背景相似度：</text>
                    <text class="value">{{ item.backgroundValue }}%</text>
                  </view>
                  <view class="detail-item">
                    <text class="label">系统设计相似度：</text>
                    <text class="value">{{ item.systemDesignValue }}%</text>
                  </view>
                  <view class="detail-item">
                    <text class="label">文档相似度：</text>
                    <text class="value">{{ item.wordValue }}%</text>
                  </view>
                  <view class="detail-item">
                    <text class="label">PDF相似度：</text>
                    <text class="value">{{ item.pdfValue }}%</text>
                  </view>
                  <view class="detail-item">
                    <text class="label">源码相似度：</text>
                    <text class="value">{{ item.sourceValue }}%</text>
                  </view>
                </view>
              </view>
            </view>
